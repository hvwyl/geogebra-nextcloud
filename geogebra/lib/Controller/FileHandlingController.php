			...
			if($path !== '') {
				...
				if($file->isUpdateable()) {
					if ($mtime != $file->getMTime()) {
						$this->logger->error("User cannot save shared file (someone updated it in the meantime): {$mtime} vs. {$file->getMTime()} {$file->getPath()}", ['app' => 'geogebra']);
				...
				$this->logger->error('No file mtime supplied', ['app' => 'geogebra']);
